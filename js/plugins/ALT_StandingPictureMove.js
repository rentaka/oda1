 ...
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_21_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_21_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_21_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_22_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_22_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_22_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_23_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_23_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_23_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_24_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_24_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_24_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_25_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_25_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_25_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_26_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_26_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_26_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_27_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_27_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_27_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_28_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_28_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_28_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_29_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_29_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
 * @param Stand_29_FileName
 * @desc プラグインコマンドで"立ち絵10"を指定した際に呼び出す画像ファイル名
 *
 * @param Stand_30_PictureNumber
 * @desc "立ち絵10"のピクチャ番号を指定
 *
 * @param Stand_30_CharacterName
 * @desc "立ち絵10"のキャラ名を設定
 *
